@echo off
REM ============================================================
REM Smart Stadium — Local Development Startup (Windows)
REM Starts backend (port 8000) and frontend (port 8501) locally
REM NOT used by Cloud Run — Cloud Run uses Dockerfiles
REM ============================================================
